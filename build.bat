...
set disableWarnings=/wd4201 /wd4100 /wd4189 /wd4505 /wd4701
set compilerFlags=/std:c++17 /MTd /MP /Od /Oi /EHsc /fp:fast /nologo /GR- /WX /W4  /FC /Z7 /openmp %buildDefines% %disableWarnings%
